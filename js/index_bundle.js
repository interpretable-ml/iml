...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleList = exports.SimpleList = function (_HTMLElement) {
	  ...
	  function SimpleList() {
	    ...
	    _this.container = _this.querySelector('.container');
	    return _this;
	  }
	  ...
	  _createClass(SimpleList, [{
	    ...
	    value: function draw(explanation) {
	      ...
	      incomingItems.append('div').classed('label', true).text(function (x) {
	        return x.name + ' (' + fmt(x.effect) + ')';
	      });
	      incomingItems.append('div').classed('padding', true).style('width', function (x) {
	        return (x.effect > 0 ? 100 : 100 + scale(x.effect)) + "px";
	      });
	      incomingItems.append('div').classed('value', true).style('width', function (x) {
